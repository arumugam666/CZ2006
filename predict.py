...
# args.predict = "UPDATE 2-Lilly gets U.S. nod for arthritis drug  sets price well below rivals"
# args.predict = "Google launches the second app in China  woos top smartphone market"
args.predict = "Tesla built a really great factory in China and attracted tons of investments"
